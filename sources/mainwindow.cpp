...
void MainWindow::style(){
    ...
    ui->pushBtn_minimize->setStyleSheet("QPushButton{border-image: url(:/images/share/images/minimize0.png);}"
                                        "QPushButton:hover{border-image: url(:/images/share/images/minimize1.png);}"
                                        "QPushButton:pressed{border-image: url(:/images/share/images/minimize3.png);}");

    ui->pushBtn_close->setStyleSheet("QPushButton{border-image: url(:/images/share/images/quit0.png);}"
                                     "QPushButton:hover{border-image: url(:/images/share/images/quit1.png);}"
                                     "QPushButton:pressed{border-image: url(:/images/share/images/quit3.png);}");

    ui->pushBtn_about->setStyleSheet("QPushButton{border-image: url(:/images/share/images/about0.png);}"
                                     "QPushButton:hover{border-image: url(:/images/share/images/about1.png);}"
                                     "QPushButton:pressed{border-image: url(:/images/share/images/about3.png);}");

    ui->pushBtn_append->setStyleSheet("QPushButton{border-image: url(:/images/share/images/append0.png);}"
                                      "QPushButton:hover{border-image: url(:/images/share/images/append1.png);}"
                                      "QPushButton:pressed{border-image: url(:/images/share/images/append3.png);}");

    ui->pushBtn_help->setStyleSheet("QPushButton{border-image: url(:/images/share/images/hint0.png);}"
                                    "QPushButton:hover{border-image: url(:/images/share/images/hint1.png);}"
                                    "QPushButton:pressed{border-image: url(:/images/share/images/hint3.png);}");
...
void MainWindow::appendAirline(Airplane a){
    planes.push_back(a);
}

void MainWindow::sortAgain(){
